      ...
      experience: {
        ...
        fields: {
          ...
          images: {
            ...
            label: "Pictures",
            optional: true,
            help: "Four circles, one per word: worship, prayer, sisterhood, encounter.",
          },
        },
      },
      ...
      stories: {
        ...
        fields: {
          ...
          images: {
            ...
            label: "Faces",
            optional: true,
            help: "Three portraits, in this order: 1) someone in their twenties. 2) someone in their sixties. 3) two generations together. They overlap into one group, so plain backgrounds work best.",
          },
        },
      },
