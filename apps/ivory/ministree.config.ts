    ...
    fields: {
      ...
      manifesto: {
        ...
        fields: {
          ...
          insetImage: { kind: "media", label: "The square one", optional: true },
        },
      },
      ...
      stages: {
        ...
        fields: {
          ...
          images: {
            ...
            optional: true,
            help: "In the same order as the three above.",
          },
        },
      },
      ...
      experience: {
        ...
        fields: {
          ...
          images: { kind: "media", multiple: true, max: 5, label: "Pictures", optional: true },
        },
      },
